  ...
  var Porto = {
    ...
    stickyHeader: function () {
      ...
      $('main').find('.sticky-header').each(function () {
        ...
        console.log($('header .sticky-header').outerHeight());
        $('main .sticky-header').css('top', $('header .sticky-header').outerHeight());
      });
    },
    ...
    mobileMenu: function () {
      //Move Mobile-Menu-Container below header
      $('.sticky-header').append($('.mobile-menu-container'));
